 ...
 */
function useView(fun, opts) {
    const { pouchdb: pouch, subscriptionManager } = (0, context_1.useContext)(opts === null || opts === void 0 ? void 0 : opts.db);
    ...
    const lastView = (0, react_1.useRef)(null);
    ...
    const startkey = (0, utils_1.useDeepMemo)(opts === null || opts === void 0 ? void 0 : opts.startkey);
    const endkey = (0, utils_1.useDeepMemo)(opts === null || opts === void 0 ? void 0 : opts.endkey);
    const key = (0, utils_1.useDeepMemo)(opts === null || opts === void 0 ? void 0 : opts.key);
    const keys = (0, utils_1.useDeepMemo)(opts === null || opts === void 0 ? void 0 : opts.keys);
        ...
        isReduce ? null : ids, (deleted, docId) => {
            ...
            if (docId === id && deleted) {
                dispatch({
                    type: 'loading_error',
                    payload: {
                        error: pouchdb_errors_1.MISSING_DOC,
                        setResult: true,
                        result: {
                            rows: [],
                            total_rows: 0,
